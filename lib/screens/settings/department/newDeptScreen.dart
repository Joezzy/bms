...
class NewDeptScreen extends StatefulWidget {
  PageSetting pageSetting;
  NewDeptScreen({Key? key, this.pageSetting=PageSetting.inApp}) : super(key: key);

  @override
  _NewDeptScreenState createState() => _NewDeptScreenState();
}

class _NewDeptScreenState extends State<NewDeptScreen> {
  String business="";
  ...
  String get category =>deptController.text;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: MyAppBar(title: "New Department",),
  ...
  void addCategoryMethod() async {
    ...
    // List res;
    try{
      final  res=  await RequestHelper.postRequestAuth(url, body);
      print("OKP");
      print(res);
      if (res[0]["status"] == "failed") {
        print(res[0]["data"]);
        ...
        if(widget.pageSetting==PageSetting.setup){
          ...
          MotionToast.success(
              ...
              description:  Text("Department Created")
          ).show(context);
